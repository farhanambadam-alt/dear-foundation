...
import { ArrowLeft, Star, MapPin, Clock, Plus, Minus, Navigation, Heart, ShieldCheck, ChevronRight, ChevronDown, Share2, Scissors, Sparkles, Award, Play, Image as ImageIcon } from 'lucide-react';
...
const SalonDetail = () => {
  ...
  return (
    <div className="min-h-screen pb-24">
      {/* ── Hero Carousel ── */}
      <div
        className="relative h-[280px] md:h-[400px] md:max-h-96 overflow-hidden md:rounded-2xl md:mx-0 md:mt-4"
      ...
      <div className="px-5 pt-5 pb-3 animate-fade-in-up" style={{ animationDelay: '80ms', animationFillMode: 'both' }}>
        ...
        <div className="flex gap-3 mt-5 pt-4 border-t border-border">
          <button className="flex-1 flex items-center justify-center gap-2 btn-themed font-heading font-semibold text-[13px] py-3.5 rounded-xl min-h-[48px]">
            <Navigation size={15} />
            Directions
          </button>
      ...
      {/* Tab Nav */}
      <div className="flex gap-1 px-5 py-2.5 md:max-w-2xl md:mx-auto">
