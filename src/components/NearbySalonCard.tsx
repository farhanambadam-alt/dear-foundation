...
const NearbySalonCard = ({ salon }: NearbySalonCardProps) => {
  ...
  return (
    <div
      ...
      className="flex-shrink-0 w-[200px] md:w-full bg-card rounded-2xl overflow-hidden card-shadow border border-border transition-all duration-200 active:scale-[0.97] cursor-pointer"
    >
